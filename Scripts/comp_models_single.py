"""Comparing baseline and vae models for the values generated from external datasets(single)"""
...
labels = ['Trametinib', 'Palbociclib', 'Tamoxifen', 'Mefloquine',
          'Withaferin' ]
colors = ['red', 'green', 'blue', 'orange', 'purple']


# Define correlation values for two models
vae_corr = np.array([vae_trametinib, vae_palbociclib, vae_tamoxifen, vae_mefloquine,
                     vae_withaferin])
model_corr = np.array([model_trametinib, model_palbociclib, model_tamoxifen, model_mefloquine,
                       model_withaferin])
# Create scatter plot
...
#plt.savefig('/disk2/user/manche/Panacea/output/plots/compare/compare_models_single.pdf', bbox_inches='tight')
plt.clf()
...
# Set x-axis limits
plt.xlim([-1, 2])
plt.savefig('/disk2/user/manche/Panacea/output/plots/compare/compare_models1_single.pdf', bbox_inches='tight')
plt.clf()
...
plt.title('Comparison of Correlation Values between Baseline and VAE Models')
#plt.savefig('/disk2/user/manche/Panacea/output/plots/compare/compare_models_box_single.pdf', bbox_inches='tight')
plt.clf()
